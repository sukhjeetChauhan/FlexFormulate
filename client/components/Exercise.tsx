...
export default function Exercise() {
  ...
  // setSchedule({ day: workoutDays, week: workoutWeek })
...
//       setCount(0)
//       currentPartIndex === schedule.workoutWeek[day]?.length - 1 // checks if current part is the last part for the day
...
//         ? setcurrentPartIndex(schedule.workoutWeek[day]?.length - 1)
...
//     day === 0
//       ? setDay(schedule.workoutDays?.length - 1)
//       : setDay(decrement(day))
//   }
//   if (e.target.className === 'nextDay') {
//     day === schedule.workoutDays?.length - 1
//       ? setDay(0)
//       : setDay(increment(day))
//   }
// }

// if (schedule.workoutWeek) {
//   return (
//     <>
//       <h1>{`Day: ${
//         schedule.workoutDays[day][0]?.toUpperCase() +
//         schedule.workoutDays[day]?.slice(1)
//       }`}</h1>
